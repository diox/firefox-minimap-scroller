...
Minimap.prototype.absoluteScrollMinimap = function(top, left) {
    ...
    contentWindow.document.documentElement.scrollTop = top;
    contentWindow.document.documentElement.scrollLeft = left;
...
Minimap.prototype.drawScroller = function() {
    ...
    let width = Math.round(this.ratiow * documentElement.clientWidth);
    let height = Math.round(this.ratioh * documentElement.clientHeight);
    let top = Math.round(this.ratioh * documentElement.scrollTop);
    let left = Math.round(this.ratiow * documentElement.scrollLeft);
/*
...
Minimap.prototype.drawMinimap = function() {
    ...
    let left = 0;
    let top = 0;
    let width = contentWindow.document.documentElement.scrollWidth;
    let height = contentWindow.document.documentElement.scrollHeight;
    if (height < 10) {
