...
Minimap.prototype.drawScroller = function() {
    ...
    if (canvasRealHeight > sidebarHeight) {
        let scrollRatio = (contentDocumentElement.scrollTop) / (contentDocumentElement.scrollHeight - contentDocumentElement.clientHeight);
        ...
        /*
        console.log('Sidebar offsetHeight: ', sidebarHeight);
        console.log('Canvas offsetHeight:', canvasRealHeight);
        console.log('Canvas height:', canvas.height);
        console.log('Scroll ratio: ', scrollRatio);
        console.log('Scroll top (document): ', contentDocumentElement.scrollTop);
        console.log('Scroll top (asked): ', sidebarScrollTop);
        sidebarScrollTop = sidebarDocument.documentElement.scrollTop;
        console.log('Scroll top (result): ', sidebarScrollTop);
        */
    }
